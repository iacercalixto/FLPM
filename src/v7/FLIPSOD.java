...
public class FLIPSOD {
	 ...
	 */
	private BPRFunctionName bprFunctionName;
	...
	private void doFLIPSODEstimation(String filePath) {
		...
		// equal lambdas
		double lambda_epslon = FLIPSOD.lambdaMaximumError;
	...
	public static void setLambdaMaximumError(double lambdaMaximumError) {
		FLIPSOD.lambdaMaximumError = lambdaMaximumError;
	}
	...
	public static void setOdMatrixMaximumError(double odMatrixMaximumError) {
		FLIPSOD.odMatrixMaximumError = odMatrixMaximumError;
	}
	...
	public void doEstimation(String filePath) throws Exception
	{
		...
		try {
			...
			double epslon = FLIPSOD.odMatrixMaximumError;
			double epslonArcFlows = FLIPSOD.arcFlowsMaximumError;
	 ...
	 */
	public BPRFunctionName getBPRFunctionName() {
	 ...
	 */
	public void setBPRFunctionName(BPRFunctionName newBprFunctionName) {
	...
	public static void setArcFlowsMaximumError(double arcFlowsMaximumError) {
		FLIPSOD.arcFlowsMaximumError = arcFlowsMaximumError;
	}
}
